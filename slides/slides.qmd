...
subtitle: "<span style='color: white;'>Behavioral Data Science Toolbox 2026</span>"
...
-   [Assignment 1](../assignments/assignment-1.html){target="_blank"} (individual): Replicate a plot with ggplot, and make an interactive plot with plotly. Due Sunday 4/10.

-   [Assignment 2](../assignments/assignment-2.html){target="_blank"} (group):
    -   Part 1: Choose a research question. Explore the data and create a set of visualizations to help you understand the data. Due Sunday 4/10, graded complete / incomplete.
    -   Part 2: Create a final data visualization that tells a story with the data. Compiled into a html document, and presented in a GitHub repository. Due Sunday 11/10.
...
-   [The data: background & codebook](../documents/data-resources.html){target="_blank"}
...
➡️ [**ggplotly() example**](https://ann1ejohansson.github.io/data-visualization-2026/worksheets/ggplotly-handout.html){target="_blank"}
...
## Requirements Assignment 1, part B
...
-   Feedback on assignment 1 and assignment 2, part 1
...
combined <- p1 + p2 +
  plot_annotation(
    ...
    subtitle = paste(
      "Exploring relationships between engine features",
      "and fuel efficiency"
    ),
...
fig_quarter <- pizza_season |>
  ...
  labs(
    title = "Pizza Season",
    subtitle = "2015, split by quarter",
    y = "Number of pizzas sold",
    x = ""
  )
...
-   Assignment 1 (individual): 25% of your final grade\
-   Assignment 2 (group): 75% of your final grade\
